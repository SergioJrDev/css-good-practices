...
<div class="report-graph">
  <div class="report-graph__background-theme report-graph__full-with" />
</div>`}
            </code>
            )
          </p>
...
<Title size='18px'>Hello, World</Title>
`}</CodeWrapper>
          </p>
        </div>
      }
...
<div style={{textAlign: 'right', display: 'inline'}}></div>
`}</CodeWrapper>
          </p>
          <p>
